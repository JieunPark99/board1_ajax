...
<head>
    ...
    <c:set var="registerFlag" value="${empty BbsListVO.id ? 'create' : 'modify'}"/>
    <title>BbsList <c:if test="${registerFlag == 'create'}"><spring:message code="button.create" /></c:if>
...
<form:form commandName="BbsListVO" id="detailForm" name="detailForm">
    <div id="content_pop">
    	<div id="title">
    		<ul>
    			<li><img src="<c:url value='/images/egovframework/example/title_dot.gif'/>" alt=""/>
                    <c:if test="${registerFlag == 'create'}">게시글 <spring:message code="button.create" /></c:if>
                    <c:if test="${registerFlag == 'modify'}">게시글 <spring:message code="button.modify" /></c:if>
                </li>
    		</ul>
    	</div>
    	<!-- // 타이틀 -->
    	...
    	<table width="100%" border="1" cellpadding="0" cellspacing="0" style="bordercolor:#D3E2EC; bordercolordark:#FFFFFF; BORDER-TOP:#C2D0DB 2px solid; BORDER-LEFT:#ffffff 1px solid; BORDER-RIGHT:#ffffff 1px solid; BORDER-BOTTOM:#C2D0DB 1px solid; border-collapse: collapse;">
    		...
    		<!-- 제목 -->
    		<tr>
    			<td class="tbtd_caption"><label for="name">제목</label></td>
    			<td class="tbtd_content">
    				<form:input path="name" maxlength="30" cssClass="txt"/>
    				&nbsp;<form:errors path="name" />
    			</td>
    		...
    		<!-- 내용 -->
    		<tr>
    			<td class="tbtd_caption"><label for="description">내용</label></td>
    			<td class="tbtd_content">
    				<form:textarea path="description" rows="8" cols="58" />&nbsp;<form:errors path="description" />
                </td>
    		</tr>
    		<!-- 비밀번호 -->
    		<tr>
    			<td class="tbtd_caption"><label for="name">비밀번호</label></td>
    			<td class="tbtd_content">
    				<form:input path="name" maxlength="30" cssClass="txt"/>
    				&nbsp;<form:errors path="name" />
    			</td>
    		...
    		<!-- 공개여부 (라디오버튼)-->
    		<tr>
    			<td class="tbtd_caption"><label for="name">공개여부</label></td>
    			<td class="tbtd_content">
    				<input type="radio" name="chk_info" value="HTML"><b> 공개</b></input>
					<input type="radio" name="chk_info" value="CSS"><b> 비공개</b></input>
    			</td>
    		</tr>
    		<!-- 상단공지여부 (체크박스) -->
    		<tr>
    			<td class="tbtd_caption"><label for="name">상단공개여부</label></td>
    			<td class="tbtd_content">
    				<label><input type="checkbox" name="color" value="blue"></input></label>
    			</td>
    		</tr>
    		<!-- 첨부파일 -->
    		<tr>
    			<td class="tbtd_caption"><label for="name">첨부파일</label></td>
    			<td class="tbtd_content">
