...
public interface SampleMapper {
	 ...
	 * @exception Exception
	 */
	void insertSample(BbsListVO vo) throws Exception;
	 ...
	 * @exception Exception
	 */
	void updateSample(BbsListVO vo) throws Exception;
	 ...
	 * @exception Exception
	 */
	void deleteSample(BbsListVO vo) throws Exception;
	 ...
	 * @exception Exception
	 */
	BbsListVO selectSample(BbsListVO vo) throws Exception;
