...
public class BbsDetailVO {
	...
	private String rnum;
	private int resultCode; //컨트롤러를 제대로 탔는지 에러 체크용
	private String preNextCode; //이전글 다음글 여부
	...
	public String getPreNextCode() {
		return preNextCode;
	}

	public void setPreNextCode(String preNextCode) {
		this.preNextCode = preNextCode;
	}

	@Override
	public String toString() {
		return "BbsDetailVO [test=" + test + ", bbs_seq=" + bbs_seq + ", title=" + title + ", name=" + name
				+ ", content=" + content + ", passwd=" + passwd + ", open_yn=" + open_yn + ", notice_yn=" + notice_yn
				+ ", reg_dt=" + reg_dt + ", mod_dt=" + mod_dt + ", view_count=" + view_count + ", id=" + id
				+ ", description=" + description + ", useYn=" + useYn + ", regUser=" + regUser + ", rnum=" + rnum
				+ ", resultCode=" + resultCode + ", preNextCode=" + preNextCode + ", atch_seq=" + atch_seq
				+ ", file_path=" + file_path + ", file_nm=" + file_nm + ", org_file_nm=" + org_file_nm + "]";
	}
